...
parser.add_argument('--batch_size_mask', dest='batch_size_mask', type=int, default=4, help='# images in batch mask')
parser.add_argument('--train_size', dest='train_size', type=int, default=1e5, help='# images used to train')
parser.add_argument('--load_size', dest='load_size', type=int, default=286, help='scale images to this size')
parser.add_argument('--fine_size', dest='fine_size', type=int, default=128, help='then crop to this size')
parser.add_argument('--time_step', dest='time_step', type=int, default=64, help='time step of pianoroll')     ##64
parser.add_argument('--pitch_range', dest='pitch_range', type=int, default=84, help='pitch range of pianoroll')    ##84
...
parser.add_argument('--d_lr', dest='d_lr', type=float, default=0.0004, help='initial learning rate for adam')
parser.add_argument('--g_lr', dest='g_lr', type=float, default=0.0001, help='initial learning rate for adam')
...
parser.add_argument('--L1_lambda', dest='L1_lambda', type=float, default=20.0, help='weight on L1 term in objective')
...
parser.add_argument('--mask_ratio', dest='mask_ratio', type=float, default=0.75, help='mask_ratio')
