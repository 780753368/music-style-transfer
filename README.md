...
```bash
python3 main.py --dataset_A_dir='JC_J' --dataset_B_dir='JC_C' --type='cyclegan' --model='full' --sigma_d=1 --phase='train'
```
There are three options for model, 'base', 'partial', 'full'. And different values can be set for sigma. 

- Test a CycleGAN model:
```bash
python3 main.py --dataset_A_dir='JC_J' --dataset_B_dir='JC_C' --type='cyclegan' --model='full' --sigma_d=1 --phase='test' --which_direction='AtoB'
```
...
```bash
python3 main.py --dataset_A_dir='JC_J' --dataset_B_dir='JC_C' --type='classifier' --sigma_c=0 --phase='train'
```

- Test the trained CycleGAN model using the trained genre classifier:
```bash
python3 main.py --dataset_A_dir='JC_J' --dataset_B_dir='JC_C' --type='classifier' --model='full' --sigma_c=0 --sigma_d=0 --phase='test' --which_direction='AtoB'
```
